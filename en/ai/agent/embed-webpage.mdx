...
<div className="w-full flex justify-center mb-8">
  <iframe src="https://app.xpertai.cn/x/call-center-chatbot" width="600" height="500" class="mx-auto shadow-lg rounded-sm border border-solid border-gray-300"></iframe>
</div>
