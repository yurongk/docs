...
参考模版 [Workflow Prompt Chaining](https://app.xpertai.cn/explore?search=Workflow%20Prompt%20Chaining) 。
...
参考模版 [Workflow Parallelization](https://app.xpertai.cn/explore?search=Workflow%20Parallelization) 。
...
参考模版 [Workflow Routing](https://app.xpertai.cn/explore?search=Workflow%20Routing) 。
...
参考模版 [Workflow Orchestrator-Worker](https://app.xpertai.cn/explore?search=Workflow%20Orchestrator-Worker) 。
...
参考模版 [Workflow Evaluator-optimizer](https://app.xpertai.cn/explore?search=Workflow%20Evaluator-optimizer) 。
...
参考模版 [OpenAI Tasks](https://app.xpertai.cn/explore?search=OpenAI%20Tasks) 。
...
参考模版 [Deep Research with Deepseek r1](https://app.xpertai.cn/explore?search=Deep%20Research%20with%20Deepseek%20r1) 。
